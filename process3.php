...
<body>
    ...
    <section class="service-section">
            ...
            <tr>
            <td> 
            Shipment No : <b>123456789</b><br>
            ส่งจาก : <?php echo GetNameAgent($_SESSION['agentId']); ?> <br><br><br>
            <b>รายการส่ง</b> <br>
            1.ร้านรุ่งโรจน์  <b>(ระยะทาง 15km)</b><br>
            2.ร้านพูนสิน 2 <b>(ระยะทาง 30km)</b><br>
            3.ร้านน้องไอเดีย<b>(ระยะทาง 8km)</b><br><br><br>

            ระยะทางรวม : <b>53km</b><br>
            ราคารวม : <b>700.93บาท</b><br>
            </td> 
            </tr>
                 </table>
                 </div>
